    ...
    module Dl
      ...
      def method_missing(method_name, *args)
        @mutex.synchronize do
          ...
          attach_function :td_json_client_receive, %i[pointer double], :string, blocking: true
          attach_function :td_json_client_send, %i[pointer string], :pointer, blocking: true
          attach_function :td_json_client_execute, %i[pointer string], :string, blocking: true
